...
class ZeroTrustRiskScoringIntegration extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustRiskScoringIntegration(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustRiskScoringIntegration:ZeroTrustRiskScoringIntegration';
    /**
