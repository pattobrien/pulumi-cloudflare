...
exports.getOauthClientsOutput = exports.getOauthClients = void 0;
 ...
 * ```
 */
function getOauthClients(args, opts) {
 ...
 * ```
 */
function getOauthClientsOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getOauthClientsOutput = getOauthClientsOutput;
//# sourceMappingURL=getOauthClients.js.map