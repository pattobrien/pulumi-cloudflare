...
exports.getSecretsStoreOutput = exports.getSecretsStore = void 0;
 ...
 * ```
 */
function getSecretsStore(args, opts) {
...
exports.getSecretsStore = getSecretsStore;
/**
 * Accepted Permissions
 *
 * - `Secrets Store Read`
 ...
 * ```
 */
function getSecretsStoreOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getSecretsStoreOutput = getSecretsStoreOutput;
//# sourceMappingURL=getSecretsStore.js.map