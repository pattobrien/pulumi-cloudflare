 ...
 * ```
 */
export declare function getIpRanges(args?: GetIpRangesArgs, opts?: pulumi.InvokeOptions): Promise<GetIpRangesResult>;
/**
 ...
 * ```
 */
export declare function getIpRangesOutput(args?: GetIpRangesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpRangesResult>;
/**
 * A collection of arguments for invoking getIpRanges.
 */
...
//# sourceMappingURL=getIpRanges.d.ts.map