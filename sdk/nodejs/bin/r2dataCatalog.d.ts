 ...
 * ```
 */
export declare class R2DataCatalog extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: R2DataCatalogState, opts?: pulumi.CustomResourceOptions): R2DataCatalog;
    /**
     * Returns true if the given object is an instance of R2DataCatalog.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is R2DataCatalog;
    /**
     ...
     */
    readonly credentialStatus: pulumi.Output<string>;
    /**
     * Configures maintenance for the catalog.
     */
    readonly maintenanceConfig: pulumi.Output<outputs.R2DataCatalogMaintenanceConfig>;
    /**
...
//# sourceMappingURL=r2dataCatalog.d.ts.map