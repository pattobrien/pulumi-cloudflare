...
class FlagshipApp extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new FlagshipApp(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/flagshipApp:FlagshipApp';
    /**
...
exports.FlagshipApp = FlagshipApp;
//# sourceMappingURL=flagshipApp.js.map