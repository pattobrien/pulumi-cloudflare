 ...
 * ```
 */
export declare class PipelineStream extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PipelineStreamState, opts?: pulumi.CustomResourceOptions): PipelineStream;
    /**
     * Returns true if the given object is an instance of PipelineStream.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PipelineStream;
    /**
    ...
    readonly format: pulumi.Output<outputs.PipelineStreamFormat | undefined>;
    readonly http: pulumi.Output<outputs.PipelineStreamHttp>;
    readonly modifiedAt: pulumi.Output<string>;
    /**
     * Specifies the name of the Stream.
     */
    readonly name: pulumi.Output<string>;
    readonly schema: pulumi.Output<outputs.PipelineStreamSchema | undefined>;
    /**
     * Indicates the current version of this stream.
     */
    readonly version: pulumi.Output<number>;
    readonly workerBinding: pulumi.Output<outputs.PipelineStreamWorkerBinding>;
    /**
...
//# sourceMappingURL=pipelineStream.d.ts.map