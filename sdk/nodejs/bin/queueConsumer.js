 ...
 */
class QueueConsumer extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new QueueConsumer(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/queueConsumer:QueueConsumer';
    /**
