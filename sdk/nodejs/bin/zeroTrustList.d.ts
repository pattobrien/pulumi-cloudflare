 ...
 * ```
 */
export declare class ZeroTrustList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustListState, opts?: pulumi.CustomResourceOptions): ZeroTrustList;
    /**
     * Returns true if the given object is an instance of ZeroTrustList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ZeroTrustList;
...
//# sourceMappingURL=zeroTrustList.d.ts.map