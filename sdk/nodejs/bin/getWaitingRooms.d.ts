 ...
 * ```
 */
export declare function getWaitingRooms(args?: GetWaitingRoomsArgs, opts?: pulumi.InvokeOptions): Promise<GetWaitingRoomsResult>;
/**
 ...
 * ```
 */
export declare function getWaitingRoomsOutput(args?: GetWaitingRoomsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWaitingRoomsResult>;
/**
 * A collection of arguments for invoking getWaitingRooms.
 */
...
//# sourceMappingURL=getWaitingRooms.d.ts.map