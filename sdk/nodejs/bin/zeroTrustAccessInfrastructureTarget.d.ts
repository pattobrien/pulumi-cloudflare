 ...
 * ```
 */
export declare class ZeroTrustAccessInfrastructureTarget extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustAccessInfrastructureTargetState, opts?: pulumi.CustomResourceOptions): ZeroTrustAccessInfrastructureTarget;
    /**
     ...
     */
    static isInstance(obj: any): obj is ZeroTrustAccessInfrastructureTarget;
    /**
     * Account identifier
     */
     ...
     */
    readonly ip: pulumi.Output<outputs.ZeroTrustAccessInfrastructureTargetIp>;
    /**
...
//# sourceMappingURL=zeroTrustAccessInfrastructureTarget.d.ts.map