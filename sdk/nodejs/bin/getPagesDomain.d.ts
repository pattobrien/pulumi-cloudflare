 ...
 * ```
 */
export declare function getPagesDomain(args: GetPagesDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetPagesDomainResult>;
/**
 ...
 * ```
 */
export declare function getPagesDomainOutput(args: GetPagesDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPagesDomainResult>;
/**
 * A collection of arguments for invoking getPagesDomain.
 */
...
//# sourceMappingURL=getPagesDomain.d.ts.map