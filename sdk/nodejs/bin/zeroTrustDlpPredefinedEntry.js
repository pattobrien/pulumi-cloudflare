...
class ZeroTrustDlpPredefinedEntry extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustDlpPredefinedEntry(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustDlpPredefinedEntry:ZeroTrustDlpPredefinedEntry';
    /**
