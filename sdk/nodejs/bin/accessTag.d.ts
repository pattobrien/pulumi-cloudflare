 ...
 */
export declare class AccessTag extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessTagState, opts?: pulumi.CustomResourceOptions): AccessTag;
    /**
     * Returns true if the given object is an instance of AccessTag.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AccessTag;
    /**
     * Identifier.
     */
...
//# sourceMappingURL=accessTag.d.ts.map