 ...
 * ```
 */
export declare function getOriginTlsComplianceModes(args: GetOriginTlsComplianceModesArgs, opts?: pulumi.InvokeOptions): Promise<GetOriginTlsComplianceModesResult>;
/**
 ...
 * ```
 */
export declare function getOriginTlsComplianceModesOutput(args: GetOriginTlsComplianceModesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOriginTlsComplianceModesResult>;
/**
 * A collection of arguments for invoking getOriginTlsComplianceModes.
 */
...
//# sourceMappingURL=getOriginTlsComplianceModes.d.ts.map