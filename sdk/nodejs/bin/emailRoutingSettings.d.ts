 ...
 * ```
 */
export declare class EmailRoutingSettings extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EmailRoutingSettingsState, opts?: pulumi.CustomResourceOptions): EmailRoutingSettings;
    /**
     * Returns true if the given object is an instance of EmailRoutingSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EmailRoutingSettings;
    /**
...
//# sourceMappingURL=emailRoutingSettings.d.ts.map