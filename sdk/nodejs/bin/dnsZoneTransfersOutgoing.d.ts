 ...
 * ```
 */
export declare class DnsZoneTransfersOutgoing extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DnsZoneTransfersOutgoingState, opts?: pulumi.CustomResourceOptions): DnsZoneTransfersOutgoing;
    /**
     * Returns true if the given object is an instance of DnsZoneTransfersOutgoing.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DnsZoneTransfersOutgoing;
    /**
     ...
     * The time for a specific event.
     */
    readonly lastTransferredTime: pulumi.Output<string>;
    /**
     * Zone name.
     */
...
//# sourceMappingURL=dnsZoneTransfersOutgoing.d.ts.map