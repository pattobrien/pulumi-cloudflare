...
class ZeroTrustDeviceManagedNetworks extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustDeviceManagedNetworks(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks';
    /**
