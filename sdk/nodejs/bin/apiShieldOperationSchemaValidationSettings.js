...
class ApiShieldOperationSchemaValidationSettings extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ApiShieldOperationSchemaValidationSettings(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/apiShieldOperationSchemaValidationSettings:ApiShieldOperationSchemaValidationSettings';
    /**
