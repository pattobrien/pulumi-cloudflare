 ...
 * ```
 */
export declare class DnsZoneTransfersPeer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DnsZoneTransfersPeerState, opts?: pulumi.CustomResourceOptions): DnsZoneTransfersPeer;
    /**
     * Returns true if the given object is an instance of DnsZoneTransfersPeer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DnsZoneTransfersPeer;
     ...
     */
    readonly ixfrEnable: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly tsigId: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=dnsZoneTransfersPeer.d.ts.map