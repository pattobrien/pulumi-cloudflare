 ...
 * ```
 */
export declare function getZeroTrustTunnelWarpConnectors(args?: GetZeroTrustTunnelWarpConnectorsArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustTunnelWarpConnectorsResult>;
/**
 * A collection of arguments for invoking getZeroTrustTunnelWarpConnectors.
 */
export interface GetZeroTrustTunnelWarpConnectorsArgs {
    /**
...
export interface GetZeroTrustTunnelWarpConnectorsResult {
     ...
     */
    readonly results: outputs.GetZeroTrustTunnelWarpConnectorsResult[];
    /**
     * The status of the tunnel. Valid values are `inactive` (tunnel has never been run), `degraded` (tunnel is active and able to serve traffic but in an unhealthy state), `healthy` (tunnel is active and able to serve traffic), or `down` (tunnel can not serve traffic as it has no connections to the Cloudflare Edge).
     * Available values: "inactive", "degraded", "healthy", "down".
     */
 ...
 * ```
 */
export declare function getZeroTrustTunnelWarpConnectorsOutput(args?: GetZeroTrustTunnelWarpConnectorsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustTunnelWarpConnectorsResult>;
/**
 * A collection of arguments for invoking getZeroTrustTunnelWarpConnectors.
 */
export interface GetZeroTrustTunnelWarpConnectorsOutputArgs {
    /**
     * Cloudflare account ID
     */
...
//# sourceMappingURL=getZeroTrustTunnelWarpConnectors.d.ts.map