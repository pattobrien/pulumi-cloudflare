 ...
 * ```
 */
export declare function getZeroTrustTunnelCloudflaredToken(args: GetZeroTrustTunnelCloudflaredTokenArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustTunnelCloudflaredTokenResult>;
/**
 ...
 * ```
 */
export declare function getZeroTrustTunnelCloudflaredTokenOutput(args: GetZeroTrustTunnelCloudflaredTokenOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustTunnelCloudflaredTokenResult>;
/**
 * A collection of arguments for invoking getZeroTrustTunnelCloudflaredToken.
 */
...
//# sourceMappingURL=getZeroTrustTunnelCloudflaredToken.d.ts.map