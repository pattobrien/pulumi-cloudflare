 ...
 */
export declare class DeviceManagedNetworks extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceManagedNetworksState, opts?: pulumi.CustomResourceOptions): DeviceManagedNetworks;
    /**
     * Returns true if the given object is an instance of DeviceManagedNetworks.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DeviceManagedNetworks;
    readonly accountId: pulumi.Output<string>;
    /**
     * The configuration object containing information for the WARP client to detect the managed network.
     */
    readonly config: pulumi.Output<outputs.DeviceManagedNetworksConfig>;
    /**
...
//# sourceMappingURL=deviceManagedNetworks.d.ts.map