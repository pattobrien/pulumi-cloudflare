 ...
 * ```
 */
export declare class ObservatoryScheduledTest extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObservatoryScheduledTestState, opts?: pulumi.CustomResourceOptions): ObservatoryScheduledTest;
    /**
     * Returns true if the given object is an instance of ObservatoryScheduledTest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ObservatoryScheduledTest;
    /**
     ...
     * The test schedule.
     */
    readonly schedule: pulumi.Output<outputs.ObservatoryScheduledTestSchedule>;
    readonly test: pulumi.Output<outputs.ObservatoryScheduledTestTest>;
    /**
     * A URL.
     */
...
//# sourceMappingURL=observatoryScheduledTest.d.ts.map