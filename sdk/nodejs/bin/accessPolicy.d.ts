...
export declare class AccessPolicy extends pulumi.CustomResource {
     ...
     */
    readonly excludes: pulumi.Output<outputs.AccessPolicyExclude[]>;
    /**
     ...
     */
    readonly mfaConfig: pulumi.Output<outputs.AccessPolicyMfaConfig | undefined>;
    /**
     ...
     */
    readonly requires: pulumi.Output<outputs.AccessPolicyRequire[]>;
