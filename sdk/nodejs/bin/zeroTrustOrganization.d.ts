...
export declare class ZeroTrustOrganization extends pulumi.CustomResource {
     ...
     */
    readonly denyUnmatchedRequests: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly denyUnmatchedRequestsExemptedZoneNames: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    readonly mfaConfig: pulumi.Output<outputs.ZeroTrustOrganizationMfaConfig | undefined>;
    /**
     ...
     */
    readonly mfaConfigurationAllowed: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly mfaRequiredForAllApps: pulumi.Output<boolean>;
    /**
     * Configures SSH PIV key requirements for MFA using hardware security keys.
     */
    readonly mfaSshPivKeyRequirements: pulumi.Output<outputs.ZeroTrustOrganizationMfaSshPivKeyRequirements | undefined>;
    /**
     ...
     */
    readonly uiReadOnlyToggleReason: pulumi.Output<string>;
    /**
...
export interface ZeroTrustOrganizationState {
    ...
    customPages?: pulumi.Input<inputs.ZeroTrustOrganizationCustomPages | undefined>;
    /**
     * Determines whether to deny all requests to Cloudflare-protected resources that lack an associated Access application. If enabled, you must explicitly configure an Access application and policy to allow traffic to your Cloudflare-protected resources. For domains you want to be public across all subdomains, add the domain to the `denyUnmatchedRequestsExemptedZoneNames` array.
     */
    ...
    loginDesign?: pulumi.Input<inputs.ZeroTrustOrganizationLoginDesign | undefined>;
    /**
     * Configures multi-factor authentication (MFA) settings for an organization.
     */
    mfaConfig?: pulumi.Input<inputs.ZeroTrustOrganizationMfaConfig | undefined>;
    /**
     * Indicates if this organization can enforce multi-factor authentication (MFA) requirements at the application and policy level.
     */
     ...
     * Configures SSH PIV key requirements for MFA using hardware security keys.
     */
    mfaSshPivKeyRequirements?: pulumi.Input<inputs.ZeroTrustOrganizationMfaSshPivKeyRequirements | undefined>;
    /**
     * The name of your Zero Trust organization.
     */
...
//# sourceMappingURL=zeroTrustOrganization.d.ts.map