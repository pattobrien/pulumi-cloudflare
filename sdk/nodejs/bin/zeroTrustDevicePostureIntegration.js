...
class ZeroTrustDevicePostureIntegration extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustDevicePostureIntegration(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustDevicePostureIntegration:ZeroTrustDevicePostureIntegration';
    /**
