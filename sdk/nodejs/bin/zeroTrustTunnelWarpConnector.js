...
class ZeroTrustTunnelWarpConnector extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustTunnelWarpConnector(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustTunnelWarpConnector:ZeroTrustTunnelWarpConnector';
    /**
