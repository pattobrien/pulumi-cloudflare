 ...
 * ```
 */
export declare function getCustomOriginTrustStore(args?: GetCustomOriginTrustStoreArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomOriginTrustStoreResult>;
/**
 ...
 * ```
 */
export declare function getCustomOriginTrustStoreOutput(args?: GetCustomOriginTrustStoreOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomOriginTrustStoreResult>;
/**
 * A collection of arguments for invoking getCustomOriginTrustStore.
 */
...
//# sourceMappingURL=getCustomOriginTrustStore.d.ts.map