 ...
 * ```
 */
export declare class WorkersRoute extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkersRouteState, opts?: pulumi.CustomResourceOptions): WorkersRoute;
    /**
     * Returns true if the given object is an instance of WorkersRoute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkersRoute;
    /**
...
//# sourceMappingURL=workersRoute.d.ts.map