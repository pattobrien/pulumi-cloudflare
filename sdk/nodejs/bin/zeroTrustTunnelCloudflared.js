...
exports.ZeroTrustTunnelCloudflared = void 0;
...
class ZeroTrustTunnelCloudflared extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustTunnelCloudflared(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared';
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === ZeroTrustTunnelCloudflared.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["configSrc"] = args?.configSrc;
...
//# sourceMappingURL=zeroTrustTunnelCloudflared.js.map