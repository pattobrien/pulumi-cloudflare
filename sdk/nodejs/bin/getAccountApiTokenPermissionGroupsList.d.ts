 ...
 * ```
 */
export declare function getAccountApiTokenPermissionGroupsList(args?: GetAccountApiTokenPermissionGroupsListArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountApiTokenPermissionGroupsListResult>;
/**
 ...
 * ```
 */
export declare function getAccountApiTokenPermissionGroupsListOutput(args?: GetAccountApiTokenPermissionGroupsListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccountApiTokenPermissionGroupsListResult>;
/**
 * A collection of arguments for invoking getAccountApiTokenPermissionGroupsList.
 */
...
//# sourceMappingURL=getAccountApiTokenPermissionGroupsList.d.ts.map