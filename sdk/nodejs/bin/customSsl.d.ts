 ...
 * ```
 */
export declare class CustomSsl extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomSslState, opts?: pulumi.CustomResourceOptions): CustomSsl;
    /**
     ...
     */
    readonly customCsrId: pulumi.Output<string | undefined>;
    /**
     * The environment to deploy the certificate to.
     * Available values: "staging", "production".
     */
    readonly deploy: pulumi.Output<string | undefined>;
    /**
    ...
    readonly keylessServer: pulumi.Output<outputs.CustomSslKeylessServer>;
    /**
     ...
     */
    readonly policyRestrictions: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=customSsl.d.ts.map