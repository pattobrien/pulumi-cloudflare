...
export declare class Workflow extends pulumi.CustomResource {
     ...
     */
    readonly defaultRetention: pulumi.Output<outputs.WorkflowDefaultRetention | undefined>;
    readonly instances: pulumi.Output<outputs.WorkflowInstances>;
    readonly isDeleted: pulumi.Output<number>;
    readonly limits: pulumi.Output<outputs.WorkflowLimits | undefined>;
    readonly modifiedOn: pulumi.Output<string>;
    readonly name: pulumi.Output<string>;
    readonly schedules: pulumi.Output<outputs.WorkflowSchedule[] | undefined>;
