 ...
 * ```
 */
export declare class ZeroTrustGatewayPacfile extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustGatewayPacfileState, opts?: pulumi.CustomResourceOptions): ZeroTrustGatewayPacfile;
    /**
     * Returns true if the given object is an instance of ZeroTrustGatewayPacfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ZeroTrustGatewayPacfile;
...
//# sourceMappingURL=zeroTrustGatewayPacfile.d.ts.map