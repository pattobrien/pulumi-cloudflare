...
class AiSearchToken extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new AiSearchToken(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/aiSearchToken:AiSearchToken';
    /**
