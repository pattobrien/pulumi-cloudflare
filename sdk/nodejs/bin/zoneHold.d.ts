 ...
 * ```
 */
export declare class ZoneHold extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZoneHoldState, opts?: pulumi.CustomResourceOptions): ZoneHold;
    /**
     * Returns true if the given object is an instance of ZoneHold.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ZoneHold;
    readonly hold: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly holdAfter: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=zoneHold.d.ts.map