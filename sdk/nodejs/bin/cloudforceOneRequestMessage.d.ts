 ...
 * ```
 */
export declare class CloudforceOneRequestMessage extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudforceOneRequestMessageState, opts?: pulumi.CustomResourceOptions): CloudforceOneRequestMessage;
    /**
     ...
     */
    static isInstance(obj: any): obj is CloudforceOneRequestMessage;
    /**
     * Identifier.
     */
     ...
     */
    readonly isFollowOnRequest: pulumi.Output<boolean>;
    /**
     * UUID.
     */
...
//# sourceMappingURL=cloudforceOneRequestMessage.d.ts.map