...
class ZeroTrustDeviceDefaultProfile extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustDeviceDefaultProfile(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustDeviceDefaultProfile:ZeroTrustDeviceDefaultProfile';
    /**
