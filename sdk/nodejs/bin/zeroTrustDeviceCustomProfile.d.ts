...
export declare class ZeroTrustDeviceCustomProfile extends pulumi.CustomResource {
     ...
     */
    readonly dnsSearchSuffixes: pulumi.Output<outputs.ZeroTrustDeviceCustomProfileDnsSearchSuffix[]>;
    /**
     ...
     */
    readonly globalAcceleration: pulumi.Output<outputs.ZeroTrustDeviceCustomProfileGlobalAcceleration | undefined>;
    /**
     ...
     */
    readonly virtualNetworks: pulumi.Output<outputs.ZeroTrustDeviceCustomProfileVirtualNetworks | undefined>;
    /**
...
export interface ZeroTrustDeviceCustomProfileState {
     ...
     * Global Acceleration settings for China. When configured, WARP clients connect to the Global Accelerator addresses instead of the default ones. Please contact your account representative to enable this feature on your account. See https://developers.cloudflare.com/china-network/concepts/global-acceleration/.
     */
    globalAcceleration?: pulumi.Input<inputs.ZeroTrustDeviceCustomProfileGlobalAcceleration | undefined>;
    /**
     * List of routes included in the WARP client's tunnel. Both 'exclude' and 'include' cannot be set in the same request.
     */
...
//# sourceMappingURL=zeroTrustDeviceCustomProfile.d.ts.map