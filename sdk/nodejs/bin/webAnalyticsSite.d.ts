 ...
 * ```
 */
export declare class WebAnalyticsSite extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebAnalyticsSiteState, opts?: pulumi.CustomResourceOptions): WebAnalyticsSite;
    /**
     * Returns true if the given object is an instance of WebAnalyticsSite.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebAnalyticsSite;
    /**
     * Identifier.
     */
     ...
     */
    readonly autoInstall: pulumi.Output<boolean | undefined>;
     ...
     */
    readonly lite: pulumi.Output<boolean | undefined>;
    /**
     * A list of rules.
     */
    readonly rules: pulumi.Output<outputs.WebAnalyticsSiteRule[]>;
    readonly ruleset: pulumi.Output<outputs.WebAnalyticsSiteRuleset>;
    /**
     * The Web Analytics site identifier.
     */
    readonly siteTag: pulumi.Output<string>;
    /**
     * The Web Analytics site token.
     */
    readonly siteToken: pulumi.Output<string>;
    /**
     * Encoded JavaScript snippet.
     */
    readonly snippet: pulumi.Output<string>;
    /**
     * The zone identifier.
     */
    readonly zoneTag: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=webAnalyticsSite.d.ts.map