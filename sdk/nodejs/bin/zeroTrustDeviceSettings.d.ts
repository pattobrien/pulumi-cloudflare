...
export declare class ZeroTrustDeviceSettings extends pulumi.CustomResource {
     ...
     */
    readonly externalEmergencySignalEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly externalEmergencySignalFingerprint: pulumi.Output<string | undefined>;
    /**
     * The interval at which the WARP client fetches the emergency disconnect signal, formatted as a duration string (e.g., "5m", "2m30s", "1h"). Minimum 30 seconds.
     */
    readonly externalEmergencySignalInterval: pulumi.Output<string | undefined>;
    /**
     * The HTTPS URL from which to fetch the emergency disconnect signal. Must use HTTPS and have an IPv4 or IPv6 address as the host.
     */
    readonly externalEmergencySignalUrl: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=zeroTrustDeviceSettings.d.ts.map