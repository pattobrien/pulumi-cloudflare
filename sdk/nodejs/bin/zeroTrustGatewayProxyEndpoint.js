...
class ZeroTrustGatewayProxyEndpoint extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustGatewayProxyEndpoint(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustGatewayProxyEndpoint:ZeroTrustGatewayProxyEndpoint';
    /**
