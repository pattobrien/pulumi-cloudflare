...
export declare class Queue extends pulumi.CustomResource {
    ...
    readonly consumers: pulumi.Output<outputs.QueueConsumer[]>;
    readonly consumersTotalCount: pulumi.Output<number>;
    readonly createdOn: pulumi.Output<string>;
    readonly modifiedOn: pulumi.Output<string>;
    readonly producers: pulumi.Output<outputs.QueueProducer[]>;
    readonly producersTotalCount: pulumi.Output<number>;
    readonly queueId: pulumi.Output<string>;
    readonly queueName: pulumi.Output<string>;
    readonly settings: pulumi.Output<outputs.QueueSettings>;
    /**
