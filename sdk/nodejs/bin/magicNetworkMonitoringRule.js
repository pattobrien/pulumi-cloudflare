...
class MagicNetworkMonitoringRule extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new MagicNetworkMonitoringRule(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/magicNetworkMonitoringRule:MagicNetworkMonitoringRule';
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["bandwidthThreshold"] = args?.bandwidthThreshold;
            ...
            resourceInputs["zscoreSensitivity"] = args?.zscoreSensitivity;
            resourceInputs["zscoreTarget"] = args?.zscoreTarget;
        }
