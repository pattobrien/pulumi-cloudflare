...
class ZeroTrustDeviceCustomProfile extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustDeviceCustomProfile(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustDeviceCustomProfile:ZeroTrustDeviceCustomProfile';
    /**
