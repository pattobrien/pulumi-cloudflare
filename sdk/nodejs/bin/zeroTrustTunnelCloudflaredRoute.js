...
class ZeroTrustTunnelCloudflaredRoute extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustTunnelCloudflaredRoute(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustTunnelCloudflaredRoute:ZeroTrustTunnelCloudflaredRoute';
    /**
