 ...
 * ```
 */
export declare class AiGateway extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiGatewayState, opts?: pulumi.CustomResourceOptions): AiGateway;
    /**
     * Returns true if the given object is an instance of AiGateway.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiGateway;
    ...
    readonly cacheInvalidateOnUpdate: pulumi.Output<boolean>;
    readonly cacheTtl: pulumi.Output<number>;
    readonly collectLogs: pulumi.Output<boolean>;
    readonly createdAt: pulumi.Output<string>;
    readonly dlp: pulumi.Output<outputs.AiGatewayDlp | undefined>;
    readonly guardrails: pulumi.Output<outputs.AiGatewayGuardrails | undefined>;
    readonly isDefault: pulumi.Output<boolean>;
    readonly logManagement: pulumi.Output<number | undefined>;
    /**
     * Available values: "STOP*INSERTING", "DELETE*OLDEST".
     */
    readonly logManagementStrategy: pulumi.Output<string | undefined>;
    readonly logpush: pulumi.Output<boolean | undefined>;
    readonly logpushPublicKey: pulumi.Output<string | undefined>;
    readonly modifiedAt: pulumi.Output<string>;
    readonly otels: pulumi.Output<outputs.AiGatewayOtel[]>;
    readonly rateLimitingInterval: pulumi.Output<number>;
    readonly rateLimitingLimit: pulumi.Output<number>;
    /**
     * Available values: "fixed", "sliding".
     */
    readonly rateLimitingTechnique: pulumi.Output<string | undefined>;
    /**
     * Backoff strategy for retry delays
     * Available values: "constant", "linear", "exponential".
     */
    readonly retryBackoff: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly retryMaxAttempts: pulumi.Output<number | undefined>;
    readonly spendLimits: pulumi.Output<outputs.AiGatewaySpendLimits>;
    readonly storeId: pulumi.Output<string | undefined>;
    readonly stripe: pulumi.Output<outputs.AiGatewayStripe | undefined>;
    /**
     * Controls how Workers AI inference calls routed through this gateway are billed. Only 'postpaid' is currently supported.
     * Available values: "postpaid".
     */
    readonly workersAiBillingMode: pulumi.Output<string>;
    readonly zdr: pulumi.Output<boolean | undefined>;
    /**
