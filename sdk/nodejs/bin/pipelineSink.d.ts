 ...
 * ```
 */
export declare class PipelineSink extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PipelineSinkState, opts?: pulumi.CustomResourceOptions): PipelineSink;
    /**
     * Returns true if the given object is an instance of PipelineSink.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PipelineSink;
    /**
     ...
     */
    readonly config: pulumi.Output<outputs.PipelineSinkConfig | undefined>;
    readonly createdAt: pulumi.Output<string>;
    readonly format: pulumi.Output<outputs.PipelineSinkFormat | undefined>;
    readonly modifiedAt: pulumi.Output<string>;
    /**
     * Defines the name of the Sink.
     */
    readonly name: pulumi.Output<string>;
    readonly schema: pulumi.Output<outputs.PipelineSinkSchema | undefined>;
    /**
...
//# sourceMappingURL=pipelineSink.d.ts.map