 ...
 * ```
 */
export declare class ZeroTrustDnsLocation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustDnsLocationState, opts?: pulumi.CustomResourceOptions): ZeroTrustDnsLocation;
    /**
     ...
     */
    readonly maxTtl: pulumi.Output<outputs.ZeroTrustDnsLocationMaxTtl>;
    /**
...
export interface ZeroTrustDnsLocationState {
     ...
     * Controls how DNS response TTLs are capped for this location relative to the account `maxTtlSecs` setting. Omitting `maxTtl` on update resets it to `inherit`.
     */
    maxTtl?: pulumi.Input<inputs.ZeroTrustDnsLocationMaxTtl | undefined>;
    /**
     * Specify the location name.
     */
...
//# sourceMappingURL=zeroTrustDnsLocation.d.ts.map