...
exports.getPipelineStreamsOutput = exports.getPipelineStreams = void 0;
 ...
 * ```
 */
function getPipelineStreams(args, opts) {
    args = args || {};
...
exports.getPipelineStreams = getPipelineStreams;
/**
 * Accepted Permissions
 *
 * - `Pipelines Read`
 ...
 * ```
 */
function getPipelineStreamsOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getPipelineStreamsOutput = getPipelineStreamsOutput;
//# sourceMappingURL=getPipelineStreams.js.map