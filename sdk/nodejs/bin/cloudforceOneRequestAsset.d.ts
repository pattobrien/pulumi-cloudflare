 ...
 * ```
 */
export declare class CloudforceOneRequestAsset extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudforceOneRequestAssetState, opts?: pulumi.CustomResourceOptions): CloudforceOneRequestAsset;
    /**
     ...
     */
    static isInstance(obj: any): obj is CloudforceOneRequestAsset;
    /**
     * Identifier.
     */
     ...
     */
    readonly page: pulumi.Output<number>;
    /**
     * Number of results per page.
     */
    readonly perPage: pulumi.Output<number>;
    /**
     * UUID.
     */
...
//# sourceMappingURL=cloudforceOneRequestAsset.d.ts.map