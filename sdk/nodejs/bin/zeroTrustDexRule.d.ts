 ...
 * ```
 */
export declare class ZeroTrustDexRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustDexRuleState, opts?: pulumi.CustomResourceOptions): ZeroTrustDexRule;
    /**
     * Returns true if the given object is an instance of ZeroTrustDexRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ZeroTrustDexRule;
    /**
    ...
    readonly targetedTests: pulumi.Output<outputs.ZeroTrustDexRuleTargetedTest[]>;
...
//# sourceMappingURL=zeroTrustDexRule.d.ts.map