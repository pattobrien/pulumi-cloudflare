...
export declare class RateLimit extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RateLimitState, opts?: pulumi.CustomResourceOptions): RateLimit;
    /**
     ...
     */
    readonly action: pulumi.Output<outputs.RateLimitAction>;
    /**
     * Criteria specifying when the current rate limit should be bypassed. You can specify that the rate limit should not apply to one or more URLs.
     */
    readonly bypasses: pulumi.Output<outputs.RateLimitBypass[]>;
    /**
     ...
     */
    readonly match: pulumi.Output<outputs.RateLimitMatch>;
    /**
