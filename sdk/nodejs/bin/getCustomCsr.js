...
exports.getCustomCsrOutput = exports.getCustomCsr = void 0;
 ...
 * ```
 */
function getCustomCsr(args, opts) {
    args = args || {};
...
exports.getCustomCsr = getCustomCsr;
/**
 * Accepted Permissions
 *
 * - `Account: SSL and Certificates Read`
 ...
 * ```
 */
function getCustomCsrOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getCustomCsrOutput = getCustomCsrOutput;
//# sourceMappingURL=getCustomCsr.js.map