 ...
 * ```
 */
export declare function getR2BucketLifecycle(args: GetR2BucketLifecycleArgs, opts?: pulumi.InvokeOptions): Promise<GetR2BucketLifecycleResult>;
/**
 ...
 * ```
 */
export declare function getR2BucketLifecycleOutput(args: GetR2BucketLifecycleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetR2BucketLifecycleResult>;
/**
 * A collection of arguments for invoking getR2BucketLifecycle.
 */
...
//# sourceMappingURL=getR2BucketLifecycle.d.ts.map