 ...
 * ```
 */
export declare function getAccessRules(args?: GetAccessRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetAccessRulesResult>;
/**
 ...
 * ```
 */
export declare function getAccessRulesOutput(args?: GetAccessRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccessRulesResult>;
/**
 * A collection of arguments for invoking getAccessRules.
 */
export interface GetAccessRulesOutputArgs {
    ...
    configuration?: pulumi.Input<inputs.GetAccessRulesConfigurationArgs | undefined>;
    /**
     * Defines the direction used to sort returned rules.
     * Available values: "asc", "desc".
     */
...
//# sourceMappingURL=getAccessRules.d.ts.map