 ...
 * ```
 */
export declare class ClientCertificate extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClientCertificateState, opts?: pulumi.CustomResourceOptions): ClientCertificate;
    /**
     ...
     */
    readonly certificateAuthority: pulumi.Output<outputs.ClientCertificateCertificateAuthority>;
    /**
     ...
     */
    readonly fingerprintSha256: pulumi.Output<string>;
    /**
    ...
    readonly reactivate: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly ski: pulumi.Output<string>;
    /**
