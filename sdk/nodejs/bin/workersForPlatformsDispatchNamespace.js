...
class WorkersForPlatformsDispatchNamespace extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new WorkersForPlatformsDispatchNamespace(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/workersForPlatformsDispatchNamespace:WorkersForPlatformsDispatchNamespace';
    /**
