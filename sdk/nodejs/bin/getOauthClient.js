...
exports.getOauthClientOutput = exports.getOauthClient = void 0;
 ...
 * ```
 */
function getOauthClient(args, opts) {
 ...
 * ```
 */
function getOauthClientOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getOauthClientOutput = getOauthClientOutput;
