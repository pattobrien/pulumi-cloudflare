 ...
 * ```
 */
export declare class TokenValidationRules extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TokenValidationRulesState, opts?: pulumi.CustomResourceOptions): TokenValidationRules;
    /**
     * Returns true if the given object is an instance of TokenValidationRules.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TokenValidationRules;
    /**
     ...
     */
    readonly position: pulumi.Output<outputs.TokenValidationRulesPosition | undefined>;
    /**
     ...
     */
    readonly selector: pulumi.Output<outputs.TokenValidationRulesSelector>;
    /**
...
//# sourceMappingURL=tokenValidationRules.d.ts.map