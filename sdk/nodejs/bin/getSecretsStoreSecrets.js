...
exports.getSecretsStoreSecretsOutput = exports.getSecretsStoreSecrets = void 0;
 ...
 * ```
 */
function getSecretsStoreSecrets(args, opts) {
...
exports.getSecretsStoreSecrets = getSecretsStoreSecrets;
/**
 * Accepted Permissions
 *
 * - `Secrets Store Read`
 ...
 * ```
 */
function getSecretsStoreSecretsOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getSecretsStoreSecretsOutput = getSecretsStoreSecretsOutput;
//# sourceMappingURL=getSecretsStoreSecrets.js.map