...
class ZeroTrustDlpPredefinedProfile extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustDlpPredefinedProfile(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustDlpPredefinedProfile:ZeroTrustDlpPredefinedProfile';
    /**
