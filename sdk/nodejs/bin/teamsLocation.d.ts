...
export declare class TeamsLocation extends pulumi.CustomResource {
     ...
     */
    readonly maxTtl: pulumi.Output<outputs.TeamsLocationMaxTtl>;
    /**
...
export interface TeamsLocationState {
     ...
     * Specify the list of network ranges from which requests at this location originate. The list takes effect only if it is non-empty and the IPv4 endpoint is enabled for this location.
     */
    networks?: pulumi.Input<pulumi.Input<inputs.TeamsLocationNetwork>[] | undefined>;
...
//# sourceMappingURL=teamsLocation.d.ts.map