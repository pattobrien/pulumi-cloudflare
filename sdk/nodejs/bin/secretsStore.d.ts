 ...
 * ```
 */
export declare class SecretsStore extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretsStoreState, opts?: pulumi.CustomResourceOptions): SecretsStore;
    /**
     * Returns true if the given object is an instance of SecretsStore.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecretsStore;
