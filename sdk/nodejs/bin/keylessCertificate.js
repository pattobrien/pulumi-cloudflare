...
exports.KeylessCertificate = void 0;
...
class KeylessCertificate extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new KeylessCertificate(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/keylessCertificate:KeylessCertificate';
    /**
