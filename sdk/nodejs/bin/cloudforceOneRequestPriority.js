...
class CloudforceOneRequestPriority extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new CloudforceOneRequestPriority(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/cloudforceOneRequestPriority:CloudforceOneRequestPriority';
    /**
