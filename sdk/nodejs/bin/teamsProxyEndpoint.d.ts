 ...
 */
export declare class TeamsProxyEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TeamsProxyEndpointState, opts?: pulumi.CustomResourceOptions): TeamsProxyEndpoint;
    /**
     * Returns true if the given object is an instance of TeamsProxyEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TeamsProxyEndpoint;
...
//# sourceMappingURL=teamsProxyEndpoint.d.ts.map