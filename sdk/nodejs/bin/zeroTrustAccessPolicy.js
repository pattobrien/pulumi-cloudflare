...
class ZeroTrustAccessPolicy extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustAccessPolicy(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustAccessPolicy:ZeroTrustAccessPolicy';
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["appCount"] = state?.appCount;
