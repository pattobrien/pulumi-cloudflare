 ...
 * ```
 */
class ZeroTrustTunnelCloudflaredVirtualNetwork extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustTunnelCloudflaredVirtualNetwork(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/zeroTrustTunnelCloudflaredVirtualNetwork:ZeroTrustTunnelCloudflaredVirtualNetwork';
    /**
...
//# sourceMappingURL=zeroTrustTunnelCloudflaredVirtualNetwork.js.map